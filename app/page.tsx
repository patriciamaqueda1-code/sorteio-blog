/**
 * / (root) — Listagem de artigos com paginação
 * Blog listing movida para o root do subdomínio (era /blog — redundante).
    ...
    <article className="flex flex-col bg-white/5 border border-white/10 rounded-2xl overflow-hidden hover:border-[#f6d27a]/40 transition-colors group">
      ...
      <div className="flex flex-col flex-1 p-5">
        ...
        <div className="flex items-center justify-between gap-2 mt-auto">
          ...
          <Link
            href={`/${post.slug}`}
            className="text-xs text-[#f6d27a] font-semibold hover:underline shrink-0"
          >
            Ler artigo →
          </Link>
        </div>
...
export default function BlogIndexPage({ searchParams }: Props) {
  return (
    <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      {/* Navegação por loteria com logos */}
      <LotteryNav />
